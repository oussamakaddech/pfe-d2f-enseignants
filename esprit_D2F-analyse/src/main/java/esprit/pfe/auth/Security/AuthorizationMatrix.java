...
public class AuthorizationMatrix {
    ...
    public static final String BESOIN_FORMATION_READ_ALL = "hasAnyRole('ROLE_ADMIN')";
    public static final String BESOIN_FORMATION_READ_CUP = "hasAnyRole('ROLE_ADMIN','ROLE_CUP')"; // CUP sees only collective needs
    public static final String BESOIN_FORMATION_READ_ENSEIGNANT = "hasAnyRole('ROLE_ADMIN','ROLE_ENSEIGNANT')"; // Enseignant sees own needs
    ...
    public static final String FORMATION_READ_OWN = "hasAnyRole('ROLE_FORMATEUR')"; // Formateur sees only own formations

    // ============ EVALUATIONS & CERTIFICATS ============
    public static final String EVALUATION_READ_ALL = "hasAnyRole('ROLE_ADMIN')";
    public static final String EVALUATION_READ_CUP = "hasAnyRole('ROLE_CUP')"; // CUP sees own UP results
    public static final String EVALUATION_READ_ENSEIGNANT = "hasAnyRole('ROLE_ENSEIGNANT')"; // Enseignant sees own results
    public static final String EVALUATION_READ_FORMATEUR = "hasAnyRole('ROLE_FORMATEUR')"; // Formateur enters grades
    ...
    public static final String DASHBOARD_ADMIN_LIMITED = "hasAnyRole('ROLE_CUP')"; // Limited to own UP
