# =============================================================================
# run-competence-sonar.ps1 - Lancer l'analyse SonarQube pour COMPETENCE-SERVICE
# =============================================================================
param(
...
Push-Location ".\esprit_D2F-competence"
try {
    ...
    .\mvnw.cmd "sonar:sonar" "-Dsonar.projectKey=competence-service" "-Dsonar.host.url=$SonarUrl" "-Dsonar.token=$token" "-Dsonar.coverage.jacoco.xmlReportPaths=target/site/jacoco/jacoco.xml"
