...
class AuthorizationFilterTest {
    ...
    @CsvSource({
        ...
        // Parité FORMATION_DELETE = ADMIN, CUP, CHEF_DEPARTEMENT.
        "/api/formation/any, DELETE, CUP, true",
        "/api/formation/any, DELETE, CHEF_DEPARTEMENT, true",
        ...
        // FORMATION_CREATE = ADMIN, CUP, CHEF_DEPARTEMENT (pas de D2F).
        "/api/formation/any, POST, D2F, false",
        "/api/formation/any, POST, CHEF_DEPARTEMENT, true",
        ...
        // MailController utilise FORMATION_CREATE : pas de D2F, chef autorisé.
        "/api/formation/mail/send, POST, D2F, false",
        "/api/formation/mail/send, POST, CHEF_DEPARTEMENT, true",
        ...
        // Parité BESOIN_FORMATION_DELETE = ADMIN, CUP, CHEF_DEPARTEMENT, ...
        "/api/besoinsformation/any, DELETE, CUP, true",
        "/api/besoinsformation/any, DELETE, CHEF_DEPARTEMENT, true",
        ...
        // Parité BESOIN_FORMATION_UPDATE = ADMIN, CUP, CHEF_DEPARTEMENT, ...
        "/api/besoinsformation/modify, PUT, CUP, true",
        "/api/besoinsformation/modify, PUT, CHEF_DEPARTEMENT, true",
