-- =============================================================================
-- V1 Baseline Migration — predictive-analytics (schéma "analyse")
-- Schéma initial tel que créé par app/infrastructure/db/init_db.py
-- (init_analyse_schema, désormais conditionné au mode développement).
-- Baseline idempotente (CREATE IF NOT EXISTS) : compatible avec une base
-- déjà peuplée avant la mise en place de Flyway.
-- Conformité DSI §3.2 — le schéma "analyse" est la propriété de app_user_analyse.
-- =============================================================================
