...
vi.mock('@/services/formation/FormationWorkflowService', () => ({
  default: {
    getAllFormationWorkflows: vi.fn(),
    getFormationWorkflowById: vi.fn(),
    getFormationsVisibles: vi.fn(),
    getFormationsAchevees: vi.fn(),
    getAllFormationWithDocuments: vi.fn(),
    getFormationsParUp: vi.fn(),
    getFormationsParDepartement: vi.fn(),
    getFormationsForCalendar: vi.fn(),
    createFormationWorkflow: vi.fn(),
    updateFormationWorkflow: vi.fn(),
    deleteFormationWorkflow: vi.fn(),
    updateInscriptionsOuvertes: vi.fn(),
...
describe('useFormations', () => {
  ...
  it('useAllFormations fetches', async () => {
    (
      FormationWorkflowService.getAllFormationWorkflows as ReturnType<typeof vi.fn>
  ...
  it('useFormationById fetches', async () => {
    (
      FormationWorkflowService.getFormationWorkflowById as ReturnType<typeof vi.fn>
  ...
  it('useFormationsWithDocuments fetches', async () => {
    (
      FormationWorkflowService.getAllFormationWithDocuments as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useFormationsParDepartement fetches', async () => {
    (
      FormationWorkflowService.getFormationsParDepartement as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
    const { result } = renderHook(() => useFormationsParDepartement(3), {
  ...
  it('useFormationsForCalendar fetches', async () => {
    (
      FormationWorkflowService.getFormationsForCalendar as ReturnType<typeof vi.fn>
    ).mockResolvedValue({ asAnimateur: [], asParticipant: [] });
  ...
  it('useCreateFormation calls service', async () => {
    (
      FormationWorkflowService.createFormationWorkflow as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useUpdateFormation calls service', async () => {
    (
      FormationWorkflowService.updateFormationWorkflow as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useDeleteFormation calls service', async () => {
    (
      FormationWorkflowService.deleteFormationWorkflow as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useUpdateInscriptionsOuvertes calls service', async () => {
    (
      FormationWorkflowService.updateInscriptionsOuvertes as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useUpdateInscriptionsOuvertes(), {
      wrapper: createWrapper(),
    });
    await act(async () => {
      await result.current.mutateAsync({ id: 1, ouvert: true } as never);
    });
