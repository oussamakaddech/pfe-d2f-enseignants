...
vi.mock("@/services/competence/CompetenceService", () => {
  ...
  ["domaine", "competence", "sousCompetence", "savoir", "enseignantCompetence", "niveauDefinition", "structure", "prerequisite"].forEach((k) => {
...
import {
  useCompetenceDomaineApi, useCompetenceApi, useSousCompetenceApi,
  useSavoirApi, useEnseignantCompetenceApi, useNiveauDefinitionApi,
  useStructureApi, usePrerequisiteApi,
