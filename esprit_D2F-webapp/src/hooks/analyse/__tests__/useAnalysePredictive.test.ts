...
import {
  useDashboardSummary,
  useTrainModel,
  useAnalyserEnseignant,
  usePredictGaps,
  useAnalyseTendancesGlobales,
  useDriftStatus,
...
vi.mock('@/services/analyse/AnalysePredictiveService', () => {
  ...
  const names = [
    ...
    'analyserEnseignant',
    'predictGaps',
    'analyserTendancesGlobales',
    'getDrift',
    'getDecliningCompetencies',
    'getInDemandCompetencies',
    'getTeacherRiskIndicators',
    'getGapHeatmap',
    'getTrainingEffectiveness',
    'getTopFormationsRecommandees',
    'getRiskEvolution',
    'getModelPerformance',
    'getOverview',
    'getDemandForecast',
    'getTrainingNeedsForecast',
    'getAlertsSummary',
    'bulkUpdateAlerts',
    'getPriorityActions',
...
describe('useAnalysePredictive', () => {
  ...
  it('useDashboardSummary fetches summary', async () => {
    (
      AnalysePredictiveService.getDashboardSummary as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({ declining_competencies: [] });
  ...
  it('useTrainModel retrains and invalidates', async () => {
    (
      AnalysePredictiveService.retrainModel as unknown as ReturnType<typeof vi.fn>
  ...
  it('useAnalyserEnseignant calls analyserEnseignant', async () => {
    (
      AnalysePredictiveService.analyserEnseignant as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useAnalyserEnseignant(), { wrapper: createWrapper() });
    await act(async () => {
      await result.current.mutateAsync({ enseignantId: 'e1', autoTrain: true } as never);
    });
    expect(AnalysePredictiveService.analyserEnseignant).toHaveBeenCalledWith('e1', undefined, {
      autoTrain: true,
    });
  });
  ...
  it('usePredictGaps calls predictGaps', async () => {
    ...
    await act(async () => {
      await result.current.mutateAsync({ enseignantId: 'e1', horizonMonths: 3 } as never);
    });
  ...
  it('useAnalyseTendancesGlobales fetches', async () => {
    (
      AnalysePredictiveService.analyserTendancesGlobales as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({ dashboard: {} });
    const { result } = renderHook(() => useAnalyseTendancesGlobales(), {
  ...
  it('useDriftStatus fetches drift', async () => {
    (AnalysePredictiveService.getDrift as unknown as ReturnType<typeof vi.fn>).mockResolvedValue({
  ...
  it('useDecliningCompetencies fetches', async () => {
    (
      AnalysePredictiveService.getDecliningCompetencies as unknown as ReturnType<typeof vi.fn>
  ...
  it('useInDemandCompetencies fetches', async () => {
    (
      AnalysePredictiveService.getInDemandCompetencies as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useTeacherRiskIndicators fetches', async () => {
    (
      AnalysePredictiveService.getTeacherRiskIndicators as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useGapHeatmap fetches', async () => {
    (
      AnalysePredictiveService.getGapHeatmap as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useTrainingEffectiveness fetches', async () => {
    (
      AnalysePredictiveService.getTrainingEffectiveness as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useTopFormations fetches', async () => {
    (
      AnalysePredictiveService.getTopFormationsRecommandees as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useRiskEvolution fetches with months arg', async () => {
    (
      AnalysePredictiveService.getRiskEvolution as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useModelPerformance fetches', async () => {
    (
      AnalysePredictiveService.getModelPerformance as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useDemandForecast fetches', async () => {
    (
      AnalysePredictiveService.getDemandForecast as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useTrainingNeedsForecast fetches with months', async () => {
    (
      AnalysePredictiveService.getTrainingNeedsForecast as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useTrainingNeedsForecast(), { wrapper: createWrapper() });
    await flushQuery(result);
    expect(
      AnalysePredictiveService.getTrainingNeedsForecast as unknown as ReturnType<typeof vi.fn>,
    ).toHaveBeenCalledWith(6, 12);
  });

  it('useAlertsSummary fetches', async () => {
    (
      AnalysePredictiveService.getAlertsSummary as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useBulkUpdateAlerts calls bulkUpdateAlerts', async () => {
    (
      AnalysePredictiveService.bulkUpdateAlerts as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useBulkUpdateAlerts(), { wrapper: createWrapper() });
    await act(async () => {
      await result.current.mutateAsync({ ids: ['a'], statut: 'LU' } as never);
    });
  ...
  it('usePriorityActions fetches with args', async () => {
    (
      AnalysePredictiveService.getPriorityActions as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
    const { result } = renderHook(() => usePriorityActions(), { wrapper: createWrapper() });
    await flushQuery(result);
    expect(
      AnalysePredictiveService.getPriorityActions as unknown as ReturnType<typeof vi.fn>,
    ).toHaveBeenCalledWith(20, undefined);
  });

  it('useBatchRecommendations calls getBatchRecommendations', async () => {
    (
      AnalysePredictiveService.getBatchRecommendations as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useBatchRecommendations(), { wrapper: createWrapper() });
    await act(async () => {
      await result.current.mutateAsync({ ids: [] } as never);
    });
  ...
  it('useSupplyDemand fetches', async () => {
    (
      AnalysePredictiveService.getSupplyDemand as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue([]);
  ...
  it('useRiskDistribution fetches', async () => {
    (
      AnalysePredictiveService.getRiskDistribution as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useHeatmapDrilldown disabled without departement', async () => {
    (
      AnalysePredictiveService.getHeatmapDrilldown as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useHeatmapDrilldown(null, null), {
      wrapper: createWrapper(),
    });
    await flushQuery(result);
  ...
  it('useTrainingImpact fetches', async () => {
    (
      AnalysePredictiveService.getTrainingImpact as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
  ...
  it('useTrainingImpactFormations fetches with page', async () => {
    (
      AnalysePredictiveService.getTrainingImpactFormations as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useTrainingImpactFormations(), {
      wrapper: createWrapper(),
    });
    await flushQuery(result);
    expect(
  ...
  it('useSimulateWhatIf calls simulateWhatIf and invalidates', async () => {
    (
      AnalysePredictiveService.simulateWhatIf as unknown as ReturnType<typeof vi.fn>
    ).mockResolvedValue({});
    const { result } = renderHook(() => useSimulateWhatIf(), { wrapper: createWrapper() });
    await act(async () => {
      await result.current.mutateAsync({ enseignant_id: 'e', plan: [] } as never);
    });
