...
describe('useBureaux', () => {
  ...
  it('useCreateBureau calls createBureau', async () => {
    ...
    await act(async () => {
      await result.current.mutateAsync({ nom: 'b' } as never);
    });
...
describe('useAnimateursExternes', () => {
  ...
  it('fetches when bureauId provided', async () => {
    (AnimateurExterneService.getByBureau as ReturnType<typeof vi.fn>).mockResolvedValue([
      { id: 1 },
    ]);
  ...
  it('useCreateAnimateurExterne calls create', async () => {
    ...
    await act(async () => {
      await result.current.mutateAsync({ bureauId: 7, data: {} } as never);
    });
  ...
  it('useUpdateAnimateurExterne calls update', async () => {
    ...
    await act(async () => {
      await result.current.mutateAsync({ bureauId: 7, id: 2, data: {} } as never);
    });
  ...
  it('useDeleteAnimateurExterne calls delete', async () => {
    ...
    await act(async () => {
      await result.current.mutateAsync({ bureauId: 7, id: 2 } as never);
    });
