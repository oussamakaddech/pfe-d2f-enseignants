...
export const FRONTEND_PERMISSIONS = {
  ...
  EVALUATION: {
    READ_ALL: ['admin', 'CUP', 'CHEF_DEPARTEMENT', 'Enseignant', 'Animateur', 'Formateur'],
    READ_FORMATION: ['admin', 'CHEF_DEPARTEMENT', 'Enseignant', 'Animateur', 'Formateur'],
    READ_CUP: ['admin', 'CUP'],
    READ_ENSEIGNANT: ['admin', 'Enseignant'],
    READ_FORMATEUR: ['admin', 'Animateur', 'Formateur'],
    CREATE: ['admin', 'Animateur', 'Enseignant', 'Formateur'],
    UPDATE: ['admin', 'Animateur', 'Enseignant', 'Formateur'],
    DELETE: ['admin'],
    MARK_ENTRY: ['admin', 'Animateur', 'Formateur'],
  },
  CERTIFICAT: {
