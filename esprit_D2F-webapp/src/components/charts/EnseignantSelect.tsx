  ...
  return (
    <Space size={8}>
      <Avatar
        size={20}
        icon={<UserOutlined />}
        style={{ backgroundColor: scoreColor(data.risk ?? 0) }}
      />
...
function renderTeacherOption(option: {
  label?: string;
  value?: string;
  data?: { teacher?: TeacherRiskIndicator; label?: string; value?: string };
}) {
  ...
  return (
    <Space size={8}>
      <Avatar
        size={20}
        icon={<UserOutlined />}
        style={{ backgroundColor: scoreColor(t.attrition_risk_score) }}
      />
