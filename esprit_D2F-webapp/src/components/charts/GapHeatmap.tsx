...
import { EyeOutlined, CloseOutlined, ArrowDownOutlined, UserOutlined } from '@ant-design/icons';
 ...
 */
const GapHeatmap = memo(function GapHeatmap({
  data,
  maxGap = 5,
  onAnalyzeTeacher,
}: GapHeatmapProps) {
  ...
  const { data: drilldownData, isLoading: drilldownLoading } = useHeatmapDrilldown(
    ...
    () => [
      ...
      },
      {
        ...
        render: (v: number) => {
          ...
          return <Tag color={tagColor}>{v}/5</Tag>;
        },
      },
      {
        title: 'Niveau Requis',
      ...
      },
      {
        ...
        render: (v: number) => {
          ...
          return <Tag color={tagColor}>{v} mois</Tag>;
        },
      },
      {
        title: 'Risque Global',
