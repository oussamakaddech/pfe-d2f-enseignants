...
import { Empty, Spin, Row, Col, Statistic, Tag, Typography, Progress, Space } from 'antd';
import { PieChartOutlined, BarChartOutlined, TeamOutlined } from '@ant-design/icons';
import { cardTooltip, subtleGrid, axisTicks, bottomLegend, hexToRgba } from './chartTheme';
...
const RiskDistributionChart = memo(function RiskDistributionChart({
  ...
  if (!data || data.total === 0) {
    return (
      <Empty
        description="Aucune donnée de distribution de risque"
