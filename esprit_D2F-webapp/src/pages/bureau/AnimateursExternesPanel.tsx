  ...
  const columns = [
    {
      ...
      render: (_: unknown, r: AnimateurExterne) => (
        <span><UserOutlined style={{ marginRight: 6, color: "#a0aec0" }} />{r.prenom} {r.nom}</span>
      ),
    },
    {
      title: "Email",
      ...
      key: "email",
      render: (email: string) =>
        email ? <span><MailOutlined style={{ marginRight: 6, color: "#a0aec0" }} />{email}</span> : <span style={{ color: "#cbd5e0" }}>—</span>,
    },
    {
      title: "Actions",
      key: "actions",
  ...
  return (
    <div style={{ padding: "8px 12px" }}>
      ...
      <Table
        ...
        loading={isLoading}
        pagination={false}
        locale={{ emptyText: <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description="Aucun animateur pour ce bureau" /> }}
      />
