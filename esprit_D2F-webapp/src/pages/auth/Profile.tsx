          ...
          <>
              ...
              <div className="profile-info-grid">
                <div className="info-item">
                  <div className="info-label">
                    <UserOutlined /> Identifiant
                  </div>
                  <div className="info-value">{profile?.userName || '-'}</div>
                </div>
                <div className="info-item">
                  <div className="info-label">
                    <MailOutlined /> Adresse E-mail
                  </div>
              ...
              <Form form={infoForm} layout="vertical" onFinish={onFinishInfo}>
                <Space direction="vertical" style={{ width: '100%' }} size="large">
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <Button onClick={() => setIsInfoDrawerOpen(false)} style={{ marginRight: 8 }}>
                      Annuler
                    </Button>
            ...
            >
              <Form form={pwdForm} layout="vertical" onFinish={onFinishPwd}>
                ...
                <Button type="primary" block htmlType="submit" loading={passwordSaving}>
                  Mettre à jour
                </Button>
              </Form>
            </Drawer>
