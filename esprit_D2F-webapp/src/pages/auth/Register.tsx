        ...
        <div className="register-card">
          ...
          >
            <Form.Item
              ...
              rules={[
                { required: true, message: "Entrez un nom d'utilisateur" },
            ...
            <Form.Item
              name="password"
              label="Mot de passe"
              help="Au moins 8 caractères, une lettre et un chiffre"
              rules={[
            ...
            <Form.Item
              ...
              rules={[
                ...
                confirmValidator('password', 'Les mots de passe ne correspondent pas'),
              ]}
            >
              <Input.Password prefix={<LockOutlined />} placeholder="••••••••" />
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                ...
                confirmValidator('email', 'Les emails ne correspondent pas'),
              ]}
            >
              <Input prefix={<MailOutlined />} placeholder="exemple@mail.com" />
            </Form.Item>
