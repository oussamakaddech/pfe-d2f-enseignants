...
export default function ReportStep({
  ...
  const historyColumns = useMemo(
    () => [
      ...
      {
        title: 'Affectations',
        dataIndex: 'affectationsCreated',
        align: 'center' as const,
        width: 110,
      },
      {
        title: 'Enseignants',
        dataIndex: 'enseignantsCovered',
        align: 'center' as const,
        width: 140,
      },
  ...
  const statCards = report
    ? [
        {
          title: 'Domaines',
          value: Number(report.domainesCreated ?? 0),
          color: '#2563eb',
          icon: <ApartmentOutlined />,
        },
        {
          title: 'Compétences',
          value: Number(report.competencesCreated ?? 0),
          color: '#10b981',
          icon: <BookOutlined />,
        },
        {
          title: 'Sous-comp.',
          value: Number(report.sousCompetencesCreated ?? 0),
          color: '#06b6d4',
          icon: <ApartmentOutlined />,
        },
        {
          title: 'Savoirs',
          value: Number(report.savoirsCreated ?? 0),
          color: '#7c3aed',
          icon: <ExperimentOutlined />,
        },
        {
          title: 'Affectations',
          value: Number(report.affectationsCreated ?? 0),
          color: '#f59e0b',
          icon: <UserOutlined />,
        },
        {
          title: 'Enseignants',
          value: Number(report.enseignantsCovered ?? 0),
          color: '#ec4899',
          icon: <UserOutlined />,
        },
      ]
  ...
  return (
    <>
      ...
      />
      <ImportSummaryCard
        importStats={importStats as Parameters<typeof ImportSummaryCard>[0]['importStats']}
      />
