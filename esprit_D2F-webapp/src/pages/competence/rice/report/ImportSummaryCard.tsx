    ...
    <>
      <Card title="Résumé de l'import" size="small" style={{ marginBottom: 16 }}>
        <Row gutter={[12, 12]}>
          <Col xs={12} md={8} lg={4}>
            <Card size="small">
              ✅ Domaines importés : <Text strong>{importStats.upserted_domaines}</Text>
            </Card>
          </Col>
          <Col xs={12} md={8} lg={4}>
            <Card size="small">
              ✅ Compétences : <Text strong>{importStats.upserted_competences}</Text>
            </Card>
          </Col>
          <Col xs={12} md={8} lg={4}>
            <Card size="small">
              ✅ Savoirs insérés : <Text strong>{importStats.inserted_savoirs}</Text>
            </Card>
          </Col>
          <Col xs={12} md={8} lg={4}>
            <Card size="small">
              🔄 Savoirs mis à jour : <Text strong>{importStats.updated_savoirs}</Text>
            </Card>
          </Col>
          <Col xs={12} md={8} lg={4}>
            <Card size="small">
              👨‍🏫 Liens enseignants : <Text strong>{importStats.inserted_enseignant_links}</Text>
            </Card>
          </Col>
          <Col xs={12} md={8} lg={4}>
            <Card size="small" style={{ borderColor: errorCount > 0 ? '#ff4d4f' : undefined }}>
              ⚠️ Erreurs :{' '}
              <Text strong style={{ color: errorCount > 0 ? '#ff4d4f' : undefined }}>
                {errorCount}
              </Text>
            </Card>
          </Col>
