        ...
        <div className="rice-success-text" style={{ flex: 1 }}>
          ...
          <p>
            {(report.message as string) ??
              'Le référentiel a été enregistré avec succès en base de données.'}
          </p>
          {!!report.generatedAt && (
            <Text type="secondary" style={{ fontSize: 12 }}>
              Généré le{' '}
              {new Date(report.generatedAt as string).toLocaleString('fr-FR', {
                dateStyle: 'medium',
                timeStyle: 'short',
              })}
            </Text>
  ...
  return (
    <div className="rice-preview-card">
      ...
      <div className="rice-preview-text" style={{ flex: 1 }}>
        ...
        <p>
          Les données ne sont pas encore enregistrées. Vérifiez le récapitulatif ci-dessous, puis
          cliquez sur « Enregistrer » lorsque vous êtes prêt.
        </p>
      </div>
