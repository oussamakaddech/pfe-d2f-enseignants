  ...
  if (loading) {
    return (
      <div style={{ marginTop: 8 }}>
          ...
          <Alert
            ...
            action={
              <Space size={4}>
                ...
                <Button size="small" type="text" onClick={onContinue}>
                  Sans enseignants
                </Button>
              </Space>
            }
        ...
        <Text
          style={{ color: 'rgba(255,255,255,0.75)', fontSize: 12, display: 'block', marginTop: 6 }}
        >
      ...
      <Space align="start">
        ...
        <div>
          <Text style={{ color: 'rgba(255,255,255,0.9)' }}>
            <strong style={{ color: '#34d399' }}>{allEnseignants.length}</strong> enseignants
            disponibles pour le matching IA
          </Text>
          {departement !== 'auto' && (
            <div>
          ...
          <div className="rice-features-panel">
            ...
            <div className="rice-feature-list">
              ...
              <div className="ens-availability">
                <Text
                  strong
                  style={{ color: '#fff', fontSize: 12, display: 'block', marginBottom: 4 }}
                >
                ...
                <>
                  {guideSteps.map((step, i) => (
                    ...
                    >
                      ...
                      <Text
                        style={{ fontSize: 12, color: 'rgba(255,255,255,0.85)', lineHeight: 1.5 }}
                      >
                ...
                <>
                  ...
                  >
                    ...
                    <div style={{ minWidth: 0, flex: 1 }}>
                      <Text
                        strong
                        style={{ fontSize: 12, color: '#fff', display: 'block', marginBottom: 4 }}
                      >
        ...
        <Table
          ...
          columns={[
            ...
            { title: 'Grade', dataIndex: 'grade', width: 90, render: (g) => g ?? '–' },
            {
              title: 'Modules',
              width: 70,
              render: (_, row) => ((row.modules as unknown[]) ?? []).length,
            },
          ]}
        />
        <Text type="secondary" style={{ fontSize: 12 }}>
