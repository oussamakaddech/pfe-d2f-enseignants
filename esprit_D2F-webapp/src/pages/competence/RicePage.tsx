...
export default function RicePage() {
  ...
  const {
    ...
    msgApi,
    createEnseignantMutate: createEnseignantHook.mutateAsync,
    setAllEnseignants,
    tree,
    setEnseignants,
    remapInTree,
  ...
  return (
    <div
      ...
      style={
        {
          '--rice-accent': DEPT_ACCENT[departement as keyof typeof DEPT_ACCENT] ?? '#1677ff',
    ...
    >
      <div className="rice-shell">
                ...
                >
                  <UploadStep
                    ...
                    handleUploadChange={(info) => {
                      const accepted = handleUploadChange(
                        info as Parameters<typeof handleUploadChange>[0],
                      );
                      if (accepted) setFiles(accepted);
                    }}
                    setCurrentStep={setCurrentStep}
                    departement={departement}
                    setDepartement={setDepartement}
                    allEnseignants={
                      allEnseignants as ComponentProps<typeof UploadStep>['allEnseignants']
                    }
              ...
              {currentStep === 2 && (
                ...
                >
                  <ReviewStep
                    ...
                    departement={departement}
                    dbEnseignants={
                      allEnseignants as ComponentProps<typeof ReviewStep>['dbEnseignants']
                    }
                    allSavoirsFlat={
                    ...
                    setCreateEnsData={
                      setCreateEnsData as ComponentProps<typeof ReviewStep>['setCreateEnsData']
                    }
              ...
              {currentStep === 3 && (
                ...
                >
                  <ReportStep
                    ...
                    departement={departement}
                    importHistory={
                      importHistory as ComponentProps<typeof ReportStep>['importHistory']
                    }
                    historyLoading={historyLoading}
                    loadImportHistory={loadImportHistory}
                    allSavoirsFlat={
                      allSavoirsFlat as ComponentProps<typeof ReportStep>['allSavoirsFlat']
                    }
                    effectiveEnseignants={
                      effectiveEnseignants as ComponentProps<
                        typeof ReportStep
                      >['effectiveEnseignants']
                    }
                    extractedEnseignants={
                      extractedEnseignants as ComponentProps<
                        typeof ReportStep
                      >['extractedEnseignants']
                    }
                    setCurrentStep={setCurrentStep}
        ...
        <MergeSavoirModal
          ...
          allSavoirsFlat={
            allSavoirsFlat as ComponentProps<typeof MergeSavoirModal>['allSavoirsFlat']
          }
