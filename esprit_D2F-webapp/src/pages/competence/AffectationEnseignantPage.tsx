...
import { Table, Input, Button, Empty, Modal, Form, Select, Row, Col, Statistic } from 'antd';
import {
  SearchOutlined,
  ReloadOutlined,
  RobotOutlined,
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      ...
      if (affResult.status === 'fulfilled')
        ...
        msgApi.warning('Impossible de charger les affectations');
        setAffectations([]);
      }
