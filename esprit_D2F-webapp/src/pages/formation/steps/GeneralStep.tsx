    ...
    <div>
      ...
      <div className="creation-section-box">
        ...
        <Row gutter={[20, 16]}>
          ...
          <Col xs={24} sm={12}>{periodCode === "OTHER" ? (<div className="creation-field"><label className="creation-field-label" htmlFor="custom-period-label">Précisez la période</label><Input id="custom-period-label" size="large" value={customPeriodLabel} onChange={(e) => setCustomPeriodLabel(e.target.value)} placeholder="Ex : Mai - Juin 2024" /></div>) : (<ChargeHoraireField chargeH={chargeH} setChargeH={setChargeH} seances={seances} toMinutes={toMinutes} />)}</Col>
          {periodCode === "OTHER" ? (<Col xs={24} sm={12}><ChargeHoraireField chargeH={chargeH} setChargeH={setChargeH} seances={seances} toMinutes={toMinutes} /></Col>) : null}
        </Row>
      </div>
      <div className="creation-section-box">
