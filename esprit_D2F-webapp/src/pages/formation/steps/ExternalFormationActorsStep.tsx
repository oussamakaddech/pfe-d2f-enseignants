import { Row, Col, Card, Typography, Alert, Empty, Divider, Tag } from 'antd';
    ...
    <div>
      ...
      <div className="creation-section-box">
        ...
        <Card className="creation-actor-card">
          ...
          <Row gutter={[16, 12]} style={{ marginTop: 24 }}>
            <Col span={24}>
              <Text strong>Animateurs externes sélectionnés ({animExterneSel.length})</Text>
            </Col>
            <Col span={24}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                  {animExterneSel.map((a) => (
                    <Tag
                      key={a.id}
                      closable
                      onClose={() => setAnimExterneSel(animExterneSel.filter((x) => x.id !== a.id))}
                    >
