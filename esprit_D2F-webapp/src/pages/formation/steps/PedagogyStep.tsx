...
export type PedagogyStepProps = {
  ...
  setPopulationCible: (v: string) => void;
  objectifs: string;
  setObjectifs: (v: string) => void;
  objectifsPedago: string;
  setObjectifsPedago: (v: string) => void;
  evalMethods: string;
  setEvalMethods: (v: string) => void;
};

export default function PedagogyStep({
  domaine,
  setDomaine,
  populationCible,
  setPopulationCible,
  ...
  const fields: {
    ...
    },
    {
      ...
      val: populationCible,
      set: setPopulationCible,
      placeholder: 'Ex : Enseignants permanents...',
    },
    {
      ...
      set: setObjectifs,
      multiline: true,
      placeholder: 'Décrire les objectifs généraux de la formation...',
    },
    {
      label: 'Objectifs Pédagogiques',
      val: objectifsPedago,
      set: setObjectifsPedago,
      multiline: true,
    ...
    },
    {
      ...
      val: evalMethods,
      set: setEvalMethods,
      placeholder: 'Ex : Quiz, Projet, QCM...',
    },
  ];
