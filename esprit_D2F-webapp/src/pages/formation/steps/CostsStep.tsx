...
export type CostsStepProps = {
  ...
  organisme: string;
  setOrganisme: (v: string) => void;
  cout: number;
  setCout: (v: number) => void;
  coutTransport: number;
  setCoutTransport: (v: number) => void;
  coutHebergement: number;
  setCoutHebergement: (v: number) => void;
  coutRepas: number;
  setCoutRepas: (v: number) => void;
};
          ...
          <Row gutter={[20, 16]}>
            <Col xs={24} sm={12}>
              <div className="creation-field">
                <label className="creation-field-label" htmlFor="cout-organisme">
            ...
            <Col xs={24} sm={12}>
              <div className="creation-field">
                <label className="creation-field-label">
                  <DollarOutlined /> Frais de Formation (DT)
                </label>
                <InputNumber
                  size="large"
                  style={{ width: '100%' }}
            ...
            <Col xs={24} sm={8}>
              <div className="creation-field">
                <label className="creation-field-label" htmlFor="cout-transport">
                  Coût Transport (DT)
                </label>
                <InputNumber
                  id="cout-transport"
                  ...
                  style={{ width: '100%' }}
                  value={coutTransport}
                  onChange={(val) => setCoutTransport(val ?? 0)}
                  min={0}
                />
              </div>
            </Col>
            <Col xs={24} sm={8}>
              <div className="creation-field">
                <label className="creation-field-label" htmlFor="cout-hebergement">
                  Coût Hébergement (DT)
                </label>
                <InputNumber
                  id="cout-hebergement"
                  ...
                  onChange={(val) => setCoutHebergement(val ?? 0)}
                  min={0}
                />
              </div>
            </Col>
            <Col xs={24} sm={8}>
              <div className="creation-field">
                <label className="creation-field-label" htmlFor="cout-repas">
                  Coût Repas (DT)
                </label>
                <InputNumber
                  id="cout-repas"
                  ...
                  style={{ width: '100%' }}
                  value={coutRepas}
                  onChange={(val) => setCoutRepas(val ?? 0)}
                  min={0}
                />
              </div>
            </Col>
