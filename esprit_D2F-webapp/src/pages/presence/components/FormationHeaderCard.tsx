        ...
        <Col xs={24} md={16}>
          ...
          <div className="fd-header-meta">
            <span className="fd-header-meta-item">
              <CalendarOutlined />
              Du {dayjs(formation.dateDebut).format('DD MMM YYYY')} au{' '}
              {dayjs(formation.dateFin).format('DD MMM YYYY')}
            </span>
        ...
        <Col xs={24} md={8}>
          <div className="fd-header-stats">
            ...
            <div className="fd-header-stat">
              ...
              <div>
                <div className="fd-header-stat-value">{participantsCount}</div>
            ...
            <div className="fd-header-stat">
              ...
              <div>
                <div className="fd-header-stat-value">{globalTaux}%</div>
