...
const rows = [
  {
    id: '1',
    formationId: 'F1',
    titreFormation: 'Python',
    dateDebut: '2026-01-01',
    dateFin: '2026-01-05',
    etat: 'PENDING',
    dateDemande: '2025-12-01',
    chargeHoraire: '20',
    competencesCiblees: ['Java', 'Python', 'C++', 'Go', 'Rust'],
    dateTraitement: null,
  },
  {
    id: '2',
    ...
    dateFin: '2026-02-05',
    etat: 'APPROVED',
    dateDemande: '2025-12-02',
    chargeHoraire: '10',
    competencesCiblees: ['Java'],
    dateTraitement: '2025-12-10',
  },
  {
    id: '3',
    formationId: 'F3',
    ...
    dateFin: '2026-03-05',
    etat: 'REJECTED',
    dateDemande: '2025-12-03',
    chargeHoraire: '15',
    competencesCiblees: [],
    dateTraitement: '2025-12-11',
    motif: 'Complet',
  },
];
...
vi.mock('utils/helpers/excelExport', () => ({
  writeExcel: excelMock.writeExcel,
  exportDateLabel: excelMock.exportDateLabel,
  isoDate: excelMock.isoDate,
}));
...
describe('MesInscriptionsTab', () => {
  ...
  it('renders header and inscription rows', () => {
    vi.mocked(extras.useMyInscriptions).mockReturnValue({
      data: rows,
      isLoading: false,
      error: null,
      refetch: vi.fn(),
  ...
  it('cancels a pending inscription', async () => {
    ...
    const success = vi.fn();
    vi.mocked(extras.useAnnulerInscription).mockReturnValue({
      mutateAsync: annuler,
      isPending: false,
    } as never);
    vi.mocked(useAppNotification).mockReturnValue({
      message: { success, error: vi.fn(), open: vi.fn() },
      modal: { confirm: vi.fn() },
    } as never);
    vi.mocked(extras.useMyInscriptions).mockReturnValue({
      data: rows,
    ...
    await waitFor(() =>
      expect(annuler).toHaveBeenCalledWith({ id: '1', enseignantId: 'e@esprit.tn' }),
    );
  });
