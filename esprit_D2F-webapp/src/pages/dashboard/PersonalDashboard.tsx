...
import {
  RocketOutlined, RightOutlined, SafetyCertificateOutlined,
  CalendarOutlined, BookOutlined, BulbOutlined, RiseOutlined,
  ThunderboltOutlined,
...
export default function PersonalDashboard({ role }: { readonly role: string }) {
  ...
  const links = [
    { label: "Mes compétences", to: "/home/competences/enseignant", icon: <SafetyCertificateOutlined />, color: "#8b5cf6" },
    { label: "Mes formations", to: "/home/Inscriptions", icon: <BookOutlined />, color: "#3b82f6" },
    { label: "Mon calendrier", to: "/home/Calendrier", icon: <CalendarOutlined />, color: "#00b4d8" },
    { label: "Déposer un besoin", to: "/home/besoins/ajouter", icon: <BulbOutlined />, color: "#f59e0b" },
  ];

  return (
    <div className="dash-container">
      <section className="dash-hero dash-hero--personal" style={{ "--hero-accent": brand[500], "--hero-accent2": accent[500] } as CSSProperties}>
      ...
      <InfoCard title="Votre espace personnel s'enrichit" icon={<RocketOutlined />} className="dash-anim">
        ...
        <button type="button" className="dash-link-btn" onClick={() => navigate("/home/competences/enseignant")}>
