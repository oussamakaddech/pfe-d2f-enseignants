...
describe('CupDashboardPage', () => {
    ...
    vi.mocked(cupMod.useCupDashboard).mockReturnValue(
      makeMock({
        ...
        timeline: {
          ...baseTimeline,
          periodes: [
            { label: '2026-01', nombreFormations: 5, nombreParticipants: 10, tauxCompletion: 80 },
            { label: '2026-02', nombreFormations: 8, nombreParticipants: 12, tauxCompletion: 90 },
          ],
          totalFormations: 13,
        },
      } as any),
  ...
  it('navigates to competences from coverage card', () => {
    ...
    const coverageLink = links.find(
      (l) => !(l.closest('button') as HTMLElement)?.className.includes('cup-kpi-link'),
    );
    ...
    vi.mocked(cupMod.useCupDashboard).mockReturnValue(
      makeMock({
        ...
        timeline: {
          ...baseTimeline,
          periodes: [
            { label: '2025-08', nombreFormations: 1, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2025-09', nombreFormations: 2, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2025-10', nombreFormations: 3, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2025-11', nombreFormations: 4, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2025-12', nombreFormations: 5, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2026-01', nombreFormations: 6, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2026-02', nombreFormations: 7, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2026-03', nombreFormations: 8, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2026-04', nombreFormations: 9, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2026-05', nombreFormations: 10, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2026-06', nombreFormations: 11, nombreParticipants: 0, tauxCompletion: 0 },
            { label: '2026-07', nombreFormations: 12, nombreParticipants: 0, tauxCompletion: 0 },
          ],
          totalFormations: 78,
        },
      } as any),
