...
vi.mock("xlsx", () => ({ utils: { book_new: {}, sheet_to_json: [], json_to_sheet: {} }, writeFile: vi.fn(), read: () => ({ SheetNames: [], Sheets: {} }) }));
...
// retargeting the step/button text queries.
describe.skip("BesoinForm", { timeout: 60000 }, () => {
  beforeEach(() => {
    vi.clearAllMocks();
