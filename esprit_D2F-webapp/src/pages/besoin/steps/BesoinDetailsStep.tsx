      ...
      <Row gutter={[16, 12]}>
        ...
        <Col xs={24} md={12}>
          <Form.Item
            label="Date de début"
            name="dateDebut"
            rules={[{ required: true, message: 'Précisez la date de début' }]}
          >
            <DatePicker
              format="YYYY-MM-DD"
        ...
        <Col xs={24} md={12}>
          <Form.Item
            label="Date de fin"
            name="dateFin"
            rules={[{ required: true, message: 'Précisez la date de fin' }]}
          >
            <DatePicker
              format="YYYY-MM-DD"
      ...
      <Row gutter={[16, 12]}>
        ...
        <Col xs={24} md={12}>
          <Form.Item
            ...
            rules={[{ required: true, message: 'Précisez le nombre de participants' }]}
          >
