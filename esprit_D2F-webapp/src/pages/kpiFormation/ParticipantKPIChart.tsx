...
const ParticipantKPIChart = () => {
  ...
  const formationsKPI: FormationKPI[] = Array.isArray(formationsKpiData)
    ? (formationsKpiData as FormationKPI[])
    : [];

  return (
    <div style={{ maxWidth: '1000px', margin: 'auto', padding: '30px' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '30px' }}>🎯 Indicateurs de Participation</h2>
