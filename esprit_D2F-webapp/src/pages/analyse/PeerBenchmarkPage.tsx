  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
        ...
        <span style={{ color: "var(--rd-muted)" }}>vs pairs {metric.pairs_moyen.toFixed(2)}{suffix}</span>
      </div>
      <Progress
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      >
        ...
        {isError && <ErrorState message="Erreur de chargement du benchmark." onRetry={() => refetch()} />}
