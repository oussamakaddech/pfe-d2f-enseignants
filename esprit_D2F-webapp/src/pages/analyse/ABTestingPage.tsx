  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <Paragraph type="secondary">
        Pilotez les experiences de variantes (MSAS hybride, collaboratif, risk-based, baseline) et
        mesurez leur impact sur l''acceptation et la completion des formations recommandees.
      </Paragraph>
      ...
      <Card style={{ marginBottom: 16 }}>
        <Space wrap>
          ...
          />
          <Button type="primary" loading={assign.isPending} onClick={handleAssign}>
            Assigner variante
          </Button>
          <Select
            value={variant}
          ...
          />
          <Button icon={<ReloadOutlined />} loading={recordEvent.isPending} onClick={handleEvent}>
