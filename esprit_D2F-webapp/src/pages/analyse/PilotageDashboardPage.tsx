...
import {
  ...
  CheckCircleOutlined, FallOutlined,
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      >
        ...
        {isError && <ErrorState message="Erreur de chargement du pilotage." onRetry={() => refetch()} />}
              ...
              {data.benchmark_departements.length === 0 ? (
                ...
                <Table
                  ...
                  columns={[
                    ...
                    { title: "Niveau moyen", dataIndex: "niveau_moyen", key: "niveau_moyen",
                      render: (v: number) => v.toFixed(2) },
                    { title: "Écart vs cohorte", dataIndex: "ecart_vs_cohorte", key: "ecart_vs_cohorte",
                      render: (v: number) => (
