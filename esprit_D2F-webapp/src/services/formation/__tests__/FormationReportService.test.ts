...
describe('FormationReportService', () => {
  ...
  it('gets formations by role and period with Date objects', async () => {
    ...
    const result = await FormationReportService.getFormationsParRoleEtPeriode(
      'animateur',
      'E1',
      start,
      end,
  ...
  it('gets formations by role and period with string dates', async () => {
    ...
    await FormationReportService.getFormationsParRoleEtPeriode(
      'participant',
      'E2',
      '2026-02-01',
      '2026-02-28',
  ...
  it('throws on error', async () => {
    ...
    await expect(
      FormationReportService.getFormationsParRoleEtPeriode('a', 'b', 'c', 'd'),
