...
const teacher: UnifiedRiskTeacher = {
  id: "ENS-1", name: "Amel Benali", department: "Info", riskScore: 0.86, riskLevel: "CRITIQUE",
  signals: ["Stagnation des compétences", "Écarts critiques"], trend: "REGRESSION",
  criticalGaps: 3, recommendedAction: "Former", recommendedTraining: null, openAlerts: 0,
};
...
describe("PriorityTeacherCard", () => {
  ...
  it("affiche '—' sans département et sans signaux", () => {
    render(<PriorityTeacherCard teacher={{ ...teacher, department: null, signals: [], criticalGaps: 0 }} />);
