...
export default function RiskCompass({
  ...
  readonly data: RiskDistribution | null;
      ...
      <div style={{ position: 'relative', flex: '0 0 auto' }}>
        ...
        >
          <div>
            ...
            <div className="rd-muted" style={{ fontSize: 11.5 }}>
              enseignants
            </div>
          </div>
        </div>
        ...
        {RISK_ORDER.map((lvl) => {
          ...
          return (
            <div
              ...
              style={{ flexDirection: 'column', alignItems: 'flex-start', gap: 2, minWidth: 84 }}
            >
              ...
              <span className="rd-muted" style={{ fontSize: 11.5, paddingLeft: 17 }}>
                {RISK_LABELS[lvl]}
              </span>
            </div>
          );
