...
describe("AlertsTrendChart", () => {
  ...
  it("affiche le svg avec une légende", () => {
    ...
    expect(container.querySelector("svg[aria-label='Tendance des alertes sur 30 jours']")).toBeInTheDocument();
  ...
  it("affiche le tooltip au survol", () => {
    ...
    svg.getBoundingClientRect = () => ({ width: 600, height: 232, top: 0, left: 0, right: 600, bottom: 232, x: 0, y: 0, toJSON: () => {} }) as DOMRect;
