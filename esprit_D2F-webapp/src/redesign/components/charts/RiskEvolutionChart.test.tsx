...
describe("RiskEvolutionChart", () => {
  ...
  it("affiche le svg et la légende", () => {
    ...
    expect(container.querySelector("svg[aria-label='Évolution mensuelle du risque']")).toBeInTheDocument();
  ...
  it("affiche le tooltip au survol", () => {
    ...
    svg.getBoundingClientRect = () => ({ width: 600, height: 230, top: 0, left: 0, right: 600, bottom: 230, x: 0, y: 0, toJSON: () => {} }) as DOMRect;
