    ...
    <div className="pm-wrap">
      <svg viewBox={`0 0 ${W} ${H}`} width="100%" style={{ display: 'block' }}>
        ...
        <rect
          ...
          width={cellW * 2}
          height={cellH * 2}
          fill={quadrantColors['low-low'].bg}
          rx={6}
        />
        <rect
          x={PAD + cellW * 2}
          ...
          width={cellW * 3}
          height={cellH * 2}
          fill={quadrantColors['low-high'].bg}
          rx={6}
        />
        <rect
          x={PAD}
          ...
          width={cellW * 2}
          height={cellH * 3}
          fill={quadrantColors['high-low'].bg}
          rx={6}
        />
        <rect
          x={PAD + cellW * 2}
          ...
          width={cellW * 3}
          height={cellH * 3}
          fill={quadrantColors['high-high'].bg}
          rx={6}
        />
        ...
        {gridLines.map((v) => (
          <g key={`g${v}`}>
            <line
              x1={PAD}
              y1={PAD + plotH - (v / 5) * plotH}
              x2={PAD + plotW}
              y2={PAD + plotH - (v / 5) * plotH}
              stroke="var(--rd-border, rgba(15,23,42,0.08))"
              strokeWidth={1}
            />
            <line
              x1={PAD + (v / 5) * plotW}
