...
const teachers: PriorityAction[] = [
  {
    enseignant_id: 'ENS-1',
    teacher_name: 'Amel Benali',
    score_risque: 0.86,
    score_action: 0.86,
    tendance: 'REGRESSION',
    niveau_risque: 'CRITIQUE',
    nb_gaps_critiques: 3,
    nb_alertes_ouvertes: 2,
    ...
    action_recommandee: 'Former Python',
    meilleure_formation: null,
    impact_estime_niveaux: null,
    historique: {
      score_precedent: 0.7,
      taux_completion: 50,
      nb_mois_stagnation: 6,
      tendance: null,
      analyse_le: null,
    },
