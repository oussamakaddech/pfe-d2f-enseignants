...
const EMAIL_KEYS = [
  "email", "mail", "e-mail", "adresse email", "adresse e-mail",
  "email_address", "emailaddress", "courriel", "courrier",
];

function normalizeHeader(h: string): string {
  return String(h || "").toLowerCase().trim().replaceAll(/\s+/g, " ");
}
...
export function getPersonEmailList(list: Array<{ id?: unknown; mail?: string; email?: string }>): string[] {
  return list
