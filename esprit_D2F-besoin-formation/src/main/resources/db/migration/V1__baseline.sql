...
-- Service    : besoinsformation-service
-- Base       : d2f (PostgreSQL)
-- =============================================================================

-- Aucune instruction SQL dans cette version baseline.
-- Le schéma existant est pris en charge par spring.flyway.baseline-on-migrate=true
-- (dev/QA) ou supposé déjà présent avant le premier déploiement avec Flyway (prod).
--
