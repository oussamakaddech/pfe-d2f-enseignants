...
public class AuthorizationMatrix {
    ...
    public static final String COMPETENCE_READ = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_CUP','ROLE_D2F','ROLE_Enseignant')";
    ...
    public static final String AFFECTATION_READ = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_CUP','ROLE_D2F')";
    public static final String AFFECTATION_CREATE = "hasAnyRole('ROLE_admin','ROLE_ADMIN')";
    public static final String AFFECTATION_UPDATE_SELF = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_CUP','ROLE_D2F','ROLE_Enseignant')"; 
    ...
    public static final String BESOIN_FORMATION_READ_CUP = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_CUP','ROLE_D2F')"; 
    public static final String BESOIN_FORMATION_READ_ENSEIGNANT = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_Enseignant')"; 
    public static final String BESOIN_FORMATION_CREATE = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_CUP','ROLE_D2F','ROLE_Enseignant')";
    ...
    public static final String FORMATION_APPROVE = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_CUP','ROLE_D2F')";
    ...
    public static final String EVALUATION_READ_CUP = "hasAnyRole('ROLE_CUP','ROLE_D2F')"; 
    ...
    public static final String CERTIFICAT_READ = "hasAnyRole('ROLE_admin','ROLE_ADMIN','ROLE_CUP','ROLE_D2F','ROLE_Enseignant','ROLE_Formateur')";
    ...
    public static final String DASHBOARD_ADMIN_LIMITED = "hasAnyRole('ROLE_CUP','ROLE_D2F')"; 
